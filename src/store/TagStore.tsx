...
const useEtiquetaStore = create((set): EtiquetaStore => ({
  etiquetas: [],
  ...
  addEtiqueta: async (dto: CreateTagDto) =>
    await axiosRequest(
      ...
      .catch((error) => {
        throw new AddTagException(TagExceptionMessages.AddTagException + error);
      }),
  ...
  deleteEtiqueta: (tagID: number) =>
    axiosRequest(
      ...
      .catch((error) => {
        throw new AddTagException(TagExceptionMessages.DeleteTagException + error);
      }),
  ...
  setEtiquetasSeleccionadas: (etiquetas: TagI[]) => {
    try {
      ...
      throw new SetSelectedTagsException(TagExceptionMessages.SetSelectedTagsException + error);
    }
  },
  ...
  addToSeleccionadas: (etiqueta: TagI) => {
    try {
      ...
      throw new AddTagToSelectedException(TagExceptionMessages.SetSelectedTagsException + error);
    }
  },
  ...
  removeFromSeleccionadas: (tagID: number) => {
    try {
      ...
      throw new RemoveTagFromSelectedException(TagExceptionMessages.SetSelectedTagsException + error);
    }
  },
  ...
  addItemTag: async (dto: CreateItemTagDto) => {
    await axiosRequest(
      ...
      throw new AddItemTagException(TagExceptionMessages.AddItemTagException + error);
    });
  },
  ...
  deleteItemTag: async (dto: CreateItemTagDto) => {
    await axiosRequest(
      ...
      throw new AddTagException(TagExceptionMessages.AddItemTagException + error);
    });
  },
}));
